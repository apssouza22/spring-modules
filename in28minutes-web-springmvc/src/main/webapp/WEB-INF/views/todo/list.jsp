    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9">
            <div class="well">
                        ...
                        <c:forEach items="${todoList}" var="currentTodo">
                            <tr>
                                ...
                                <td><a class="btn btn-mini btn-primary"
                                       href="/in28minutes-web-springmvc/user/todos/${currentTodo.id}/update"><i
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="/in28minutes-web-springmvc/user/todos/${currentTodo.id}/delete"
                                                          method="post">
                ...
                <div align="center">
                    <a class="btn btn-success" href="/in28minutes-web-springmvc/user/todos/new"> New To Do </a>
