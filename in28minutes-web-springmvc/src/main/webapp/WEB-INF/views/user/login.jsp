            ...
            <form:form class="well form-horizontal" method="post" action="login.do" modelAttribute="loginForm">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <form:input path="email" id="email" type="text" value="user@in28minutes.com" class="input-medium" placeholder="your@email.com" required="required"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <form:input type="password" path="password" id="password" value="password" class="input-medium" placeholder="min 6 characters" required="required"/>
